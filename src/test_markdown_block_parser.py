...
from markdown_block_parser import BlockType, block_to_block_type, extract_title, is_code_block, is_heading, is_ordered_list, is_quote_block, is_unordered_list, markdown_to_blocks
...
"""
    ...
    def test_extract_title_fail(self):
        with self.assertRaises(ValueError) as context:
            extract_title('#Hello')
        self.assertIn("There needs to be an `h1` header at the start of the page!", str(context.exception))
